...
* [BLKSTACK - The anti-framework, framework; boilerplate + example. Built on Docker, SSL, Node.js, Postgres, React, Redux, Graphql, RXjs, Server Side Rendering, Code Splitting, Hot Module Reloading](https://github.com/Alex-ray/docker-postgres-react-redux-graphql-hmr-ssr-kit)
