...
- [openhive](https://github.com/arseneHuot/openhive) - Open-source, self-hosted team messaging platform (Slack alternative) with channels, DMs, threads, and video calls
