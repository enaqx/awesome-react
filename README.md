...
- [Real World Example App (Social Blogging)](https://github.com/arrlancore/nextjs-ssr-real-world-app-example) - Exemplary medium.com clone of Universal React App with next.js
