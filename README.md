...
- [react-doctor](https://github.com/softar-dev/React_Doctor) - Combines static AST analysis with real browser profiling to correlate code patterns with actual re-render behavior
