...
* [styled-components](https://github.com/styled-components/styled-components) [![GitHub stars](https://img.shields.io/github/stars/styled-components/styled-components.svg?style=social&label=Stars)](https://github.com/styled-components/styled-components)
...
* [Serverside rendering with React + Hapi](https://github.com/jedireza/hapi-react-views) [![GitHub stars](https://img.shields.io/github/stars/jedireza/hapi-react-views.svg?style=social&label=Stars)](https://github.com/jedireza/hapi-react-views)
...
* [ASP.NET Core Starter Kit (F#) — Frontend: React, Babel, PostCSS, CSS Modules + backend: .NET Core, F#](https://github.com/kriasoft/fsharp-starter-kit) [![GitHub stars](https://img.shields.io/github/stars/kriasoft/fsharp-starter-kit.svg?style=social&label=Stars)](https://github.com/kriasoft/fsharp-starter-kit)
...
* [react-frame-component - Render your React app to an iFrame](https://github.com/ryanseddon/react-frame-component) [![GitHub stars](https://img.shields.io/github/stars/ryanseddon/react-frame-component.svg?style=social&label=Stars)](https://github.com/ryanseddon/react-frame-component)
...
* [react-lorem-component - Renders lorem ipsum placeholder text](https://github.com/martinandert/react-lorem-component) [![GitHub stars](https://img.shields.io/github/stars/martinandert/react-lorem-component.svg?style=social&label=Stars)](https://github.com/martinandert/react-lorem-component)
...
* [react-anything-sortable - A sortable component with IE8 compatibility](https://github.com/jasonslyvia/react-anything-sortable) [![GitHub stars](https://img.shields.io/github/stars/jasonslyvia/react-anything-sortable.svg?style=social&label=Stars)](https://github.com/jasonslyvia/react-anything-sortable)
...
* [react-select-box - An accessible select box component for React](https://github.com/instructure/react-select-box) [![GitHub stars](https://img.shields.io/github/stars/instructure/react-select-box.svg?style=social&label=Stars)](https://github.com/instructure/react-select-box)
...
* [react-colorpicker - Colorpicker for React](https://github.com/stayradiated/react-colorpicker) [![GitHub stars](https://img.shields.io/github/stars/stayradiated/react-colorpicker.svg?style=social&label=Stars)](https://github.com/stayradiated/react-colorpicker)
...
* [react-select - Rich Select Component](https://github.com/JedWatson/react-select) [![GitHub stars](https://img.shields.io/github/stars/JedWatson/react-select.svg?style=social&label=Stars)](https://github.com/JedWatson/react-select)
...
* [react-scrollbar - Simple ScrollArea component built for React](https://github.com/souhe/reactScrollbar) [![GitHub stars](https://img.shields.io/github/stars/souhe/reactScrollbar.svg?style=social&label=Stars)](https://github.com/souhe/reactScrollbar)
...
* [react-https-redirect - Force a redirect to HTTPS when not on a local web server](https://github.com/mbasso/react-https-redirect) [![GitHub stars](https://img.shields.io/github/stars/mbasso/react-https-redirect.svg?style=social&label=Stars)](https://github.com/mbasso/react-https-redirect)
...
* [Maple.js - Bringing the concept of web-components to React](https://github.com/Wildhoney/Maple.js) [![GitHub stars](https://img.shields.io/github/stars/Wildhoney/Maple.js.svg?style=social&label=Stars)](https://github.com/Wildhoney/Maple.js)
...
* [React Laravel](https://github.com/talyssonoc/react-laravel) [![GitHub stars](https://img.shields.io/github/stars/talyssonoc/react-laravel.svg?style=social&label=Stars)](https://github.com/talyssonoc/react-laravel)
...
* [react-topcoat by @arnemart - A collection of React components for Topcoat](https://github.com/arnemart/react-topcoat) [![GitHub stars](https://img.shields.io/github/stars/arnemart/react-topcoat.svg?style=social&label=Stars)](https://github.com/arnemart/react-topcoat)
...
* [react-masonry-mixin - Standalone mixin for Masonry (@desandro)](https://github.com/eiriklv/react-masonry-mixin) [![GitHub stars](https://img.shields.io/github/stars/eiriklv/react-masonry-mixin.svg?style=social&label=Stars)](https://github.com/eiriklv/react-masonry-mixin)
...
* [imvvm - Immutable Model-View-ViewModel for React](https://github.com/entrendipity/imvvm) [![GitHub stars](https://img.shields.io/github/stars/entrendipity/imvvm.svg?style=social&label=Stars)](https://github.com/entrendipity/imvvm)
* [morearty.js - Better state management for React in pure JavaScript](https://github.com/moreartyjs/moreartyjs) [![GitHub stars](https://img.shields.io/github/stars/moreartyjs/moreartyjs.svg?style=social&label=Stars)](https://github.com/moreartyjs/moreartyjs)
* [valuable - An immutable data store for React](https://github.com/josephsavona/valuable) [![GitHub stars](https://img.shields.io/github/stars/josephsavona/valuable.svg?style=social&label=Stars)](https://github.com/josephsavona/valuable)
* [react-resolver - Isomorphic library to recursively lazy-load data for React components](https://github.com/ericclemmons/react-resolver) [![GitHub stars](https://img.shields.io/github/stars/ericclemmons/react-resolver.svg?style=social&label=Stars)](https://github.com/ericclemmons/react-resolver)
* [freezer-js - Lightweight and reactive immutable data structure for React](https://github.com/arqex/freezer) [![GitHub stars](https://img.shields.io/github/stars/arqex/freezer.svg?style=social&label=Stars)](https://github.com/arqex/freezer)
* [MobX - Simple, scalable state management](https://mobxjs.github.io/mobx)
* [baobab - JavaScript persistent and optionally immutable data tree with cursors](https://github.com/Yomguithereal/baobab) [![GitHub stars](https://img.shields.io/github/stars/Yomguithereal/baobab.svg?style=social&label=Stars)](https://github.com/Yomguithereal/baobab)
* [baobab-react - React integration for Baobab](https://github.com/Yomguithereal/baobab-react) [![GitHub stars](https://img.shields.io/github/stars/Yomguithereal/baobab-react.svg?style=social&label=Stars)](https://github.com/Yomguithereal/baobab-react)
* [datascript - Immutable database and Datalog query engine in ClojureScript](https://github.com/tonsky/datascript) [![GitHub stars](https://img.shields.io/github/stars/tonsky/datascript.svg?style=social&label=Stars)](https://github.com/tonsky/datascript)
* [immstruct - Immutable data structures with history for top-to-bottom properties in component based libraries like React](https://github.com/omniscientjs/immstruct) [![GitHub stars](https://img.shields.io/github/stars/omniscientjs/immstruct.svg?style=social&label=Stars)](https://github.com/omniscientjs/immstruct)
* [seamless-immutable - Immutable data structures for JavaScript which are backwards-compatible with normal JS Arrays and Objects](https://github.com/rtfeldman/seamless-immutable) [![GitHub stars](https://img.shields.io/github/stars/rtfeldman/seamless-immutable.svg?style=social&label=Stars)](https://github.com/rtfeldman/seamless-immutable)
* [tydel - Typed Models and Collections, with React bindings](http://tydel.js.org)
* [extendable-immutable - Extend any Immutable.js data structure](https://github.com/philpl/extendable-immutable) [![GitHub stars](https://img.shields.io/github/stars/philpl/extendable-immutable.svg?style=social&label=Stars)](https://github.com/philpl/extendable-immutable)

##### React Development Experience
* [react-devtools - React Chrome Developer Tools](https://github.com/facebook/react-devtools) [![GitHub stars](https://img.shields.io/github/stars/facebook/react-devtools.svg?style=social&label=Stars)](https://github.com/facebook/react-devtools)
* [react-transform-hmr - A React Transform that enables hot reloading React](https://github.com/gaearon/react-transform-hmr) [![GitHub stars](https://img.shields.io/github/stars/gaearon/react-transform-hmr.svg?style=social&label=Stars)](https://github.com/gaearon/react-transform-hmr)
* [Nuclide - An open IDE for web and native mobile development, built on top of Atom](http://nuclide.io/)
* [babel-sublime - Syntax definitions for ES6 JavaScript with React JSX extensions](https://github.com/babel/babel-sublime) [![GitHub stars](https://img.shields.io/github/stars/babel/babel-sublime.svg?style=social&label=Stars)](https://github.com/babel/babel-sublime)
* [babel-sublime-snippets - Next generation JavaScript and React snippets for Sublime](https://github.com/babel/babel-sublime-snippets) [![GitHub stars](https://img.shields.io/github/stars/babel/babel-sublime-snippets.svg?style=social&label=Stars)](https://github.com/babel/babel-sublime-snippets)
* [atom-react - Atom React.js support](https://atom.io/packages/react)
* [vim-jsx - Vim JSX Syntax](https://github.com/mxw/vim-jsx) [![GitHub stars](https://img.shields.io/github/stars/mxw/vim-jsx.svg?style=social&label=Stars)](https://github.com/mxw/vim-jsx)
* [vim-react-snippets - Vim version of the snippets from sublime-react](https://github.com/justinj/vim-react-snippets) [![GitHub stars](https://img.shields.io/github/stars/justinj/vim-react-snippets.svg?style=social&label=Stars)](https://github.com/justinj/vim-react-snippets)
* [vim-babel - Wrapper around babel.js for vim](https://github.com/jbgutierrez/vim-babel) [![GitHub stars](https://img.shields.io/github/stars/jbgutierrez/vim-babel.svg?style=social&label=Stars)](https://github.com/jbgutierrez/vim-babel)
* [web-mode.el - An autonomous emacs major-mode for editing web templates](http://web-mode.org/)
* [eslint-plugin-react - React specific linting rules for ESLint](https://github.com/yannickcr/eslint-plugin-react) [![GitHub stars](https://img.shields.io/github/stars/yannickcr/eslint-plugin-react.svg?style=social&label=Stars)](https://github.com/yannickcr/eslint-plugin-react)
* [generator-react-webpack - Yeoman generator for ReactJS and Webpack](https://github.com/newtriks/generator-react-webpack) [![GitHub stars](https://img.shields.io/github/stars/newtriks/generator-react-webpack.svg?style=social&label=Stars)](https://github.com/newtriks/generator-react-webpack)
* [generator-react-gulp-browserify - Yeoman generator for React](https://github.com/randylien/generator-react-gulp-browserify) [![GitHub stars](https://img.shields.io/github/stars/randylien/generator-react-gulp-browserify.svg?style=social&label=Stars)](https://github.com/randylien/generator-react-gulp-browserify)
* [generator-reactapp - Yeoman generator for react app with redux, webpack, gulp and restful.js etc.](https://github.com/Jackong/generator-reactapp) [![GitHub stars](https://img.shields.io/github/stars/Jackong/generator-reactapp.svg?style=social&label=Stars)](https://github.com/Jackong/generator-reactapp)
* [static-site-generator-webpack-plugin - Prerender isomorphic JavaScript apps to static HTML](https://github.com/markdalgleish/static-site-generator-webpack-plugin) [![GitHub stars](https://img.shields.io/github/stars/markdalgleish/static-site-generator-webpack-plugin.svg?style=social&label=Stars)](https://github.com/markdalgleish/static-site-generator-webpack-plugin)
* [React Storybook - UI Component Dev Environment for React](https://github.com/kadirahq/react-storybook) [![GitHub stars](https://img.shields.io/github/stars/kadirahq/react-storybook.svg?style=social&label=Stars)](https://github.com/kadirahq/react-storybook)
* [generator-sui-react - A yeoman generator for Schibsted User Interface (SUI) ReactJS components](https://github.com/SUI-Components/generator-sui-react) [![GitHub stars](https://img.shields.io/github/stars/SUI-Components/generator-sui-react.svg?style=social&label=Stars)](https://github.com/SUI-Components/generator-sui-react)
* [Racket - A yeoman generator for creating a universal react/redux web application](https://github.com/mohebifar/racket) [![GitHub stars](https://img.shields.io/github/stars/mohebifar/racket.svg?style=social&label=Stars)](https://github.com/mohebifar/racket)

##### Template Engines
 * [react-templates - Lightweight templates for React](https://github.com/wix/react-templates) [![GitHub stars](https://img.shields.io/github/stars/wix/react-templates.svg?style=social&label=Stars)](https://github.com/wix/react-templates)
 * [teact - A JSX alternative based on composing functions in the Markaby / CoffeeKup / Teacup tradition](https://github.com/hurrymaplelad/teact) [![GitHub stars](https://img.shields.io/github/stars/hurrymaplelad/teact.svg?style=social&label=Stars)](https://github.com/hurrymaplelad/teact)

##### Maps
* [react-googlemaps - React interface to Google maps](https://github.com/pieterv/react-googlemaps) [![GitHub stars](https://img.shields.io/github/stars/pieterv/react-googlemaps.svg?style=social&label=Stars)](https://github.com/pieterv/react-googlemaps)
* [react-maps - A map component for React](https://github.com/matnel/react-maps) [![GitHub stars](https://img.shields.io/github/stars/matnel/react-maps.svg?style=social&label=Stars)](https://github.com/matnel/react-maps)
* [react-google-maps - React.js Google Maps integration component](https://github.com/tomchentw/react-google-maps) [![GitHub stars](https://img.shields.io/github/stars/tomchentw/react-google-maps.svg?style=social&label=Stars)](https://github.com/tomchentw/react-google-maps)
* [react-gmaps - A Google Maps component for React.js](https://github.com/MicheleBertoli/react-gmaps) [![GitHub stars](https://img.shields.io/github/stars/MicheleBertoli/react-gmaps.svg?style=social&label=Stars)](https://github.com/MicheleBertoli/react-gmaps)
* [react-map-gl - A React wrapper for MapboxGL-js plus overlay API](https://github.com/uber/react-map-gl) [![GitHub stars](https://img.shields.io/github/stars/uber/react-map-gl.svg?style=social&label=Stars)](https://github.com/uber/react-map-gl)
* [google-map-react - Isomorphic google map React component](https://github.com/istarkov/google-map-react) [![GitHub stars](https://img.shields.io/github/stars/istarkov/google-map-react.svg?style=social&label=Stars)](https://github.com/istarkov/google-map-react)
* [react-mapbox-gl - A mapbox-gl-js wrapper to make the API react friendly](https://github.com/alex3165/react-mapbox-gl) [![GitHub stars](https://img.shields.io/github/stars/alex3165/react-mapbox-gl.svg?style=social&label=Stars)](https://github.com/alex3165/react-mapbox-gl)

##### Charts
* [react-d3 - Modular React charts made with d3.js](https://github.com/esbullington/react-d3) [![GitHub stars](https://img.shields.io/github/stars/esbullington/react-d3.svg?style=social&label=Stars)](https://github.com/esbullington/react-d3)
* [react-chartjs - Common react charting components using chart.js](https://github.com/jhudson8/react-chartjs) [![GitHub stars](https://img.shields.io/github/stars/jhudson8/react-chartjs.svg?style=social&label=Stars)](https://github.com/jhudson8/react-chartjs)
* [react-stockcharts - Highly customizable stock charts with ReactJS and d3](https://github.com/rrag/react-stockcharts) [![GitHub stars](https://img.shields.io/github/stars/rrag/react-stockcharts.svg?style=social&label=Stars)](https://github.com/rrag/react-stockcharts)
* [VictoryJS - A collection of composable React components for building interactive data visualizations](https://github.com/FormidableLabs/victory) [![GitHub stars](https://img.shields.io/github/stars/FormidableLabs/victory.svg?style=social&label=Stars)](https://github.com/FormidableLabs/victory)
* [Recharts - A charting library built on D3 with an awesome declarative API](https://github.com/recharts/recharts) [![GitHub stars](https://img.shields.io/github/stars/recharts/recharts.svg?style=social&label=Stars)](https://github.com/recharts/recharts)
...
* [React Native GitHub](https://github.com/facebook/react-native) [![GitHub stars](https://img.shields.io/github/stars/facebook/react-native.svg?style=social&label=Stars)](https://github.com/facebook/react-native)
* [React Native Newsletter](http://brentvatne.ca/react-native-newsletter/)
* [React Native Playground](https://rnplay.org/)
* [React Native Awesome List](https://github.com/jondot/awesome-react-native) [![GitHub stars](https://img.shields.io/github/stars/jondot/awesome-react-native.svg?style=social&label=Stars)](https://github.com/jondot/awesome-react-native)
...
* [react-native-webpack-server - Build React Native apps with Webpack](https://github.com/mjohnston/react-native-webpack-server) [![GitHub stars](https://img.shields.io/github/stars/mjohnston/react-native-webpack-server.svg?style=social&label=Stars)](https://github.com/mjohnston/react-native-webpack-server)
* [react-native-code-push - React Native plugin for the CodePush service](https://github.com/Microsoft/react-native-code-push) [![GitHub stars](https://img.shields.io/github/stars/Microsoft/react-native-code-push.svg?style=social&label=Stars)](https://github.com/Microsoft/react-native-code-push)
...
* [HackerNews](https://github.com/iSimar/HackerNews-React-Native) [![GitHub stars](https://img.shields.io/github/stars/iSimar/HackerNews-React-Native.svg?style=social&label=Stars)](https://github.com/iSimar/HackerNews-React-Native)
* [Ziliun](https://github.com/sonnylazuardi/ziliun-react-native) [![GitHub stars](https://img.shields.io/github/stars/sonnylazuardi/ziliun-react-native.svg?style=social&label=Stars)](https://github.com/sonnylazuardi/ziliun-react-native)
* [FinanceReactNative](https://github.com/7kfpun/FinanceReactNative) [![GitHub stars](https://img.shields.io/github/stars/7kfpun/FinanceReactNative.svg?style=social&label=Stars)](https://github.com/7kfpun/FinanceReactNative)
* [SplashWalls](https://github.com/nashvail/SplashWalls) [![GitHub stars](https://img.shields.io/github/stars/nashvail/SplashWalls.svg?style=social&label=Stars)](https://github.com/nashvail/SplashWalls)
* [NBAreact](https://github.com/jbkuczma/NBAreact) [![GitHub stars](https://img.shields.io/github/stars/jbkuczma/NBAreact.svg?style=social&label=Stars)](https://github.com/jbkuczma/NBAreact)

#### React Native Boilerplates
* [Snowflake - React Native iOS & Android with Redux, Parse.com, Jest (88% coverage)](https://github.com/bartonhammond/snowflake) [![GitHub stars](https://img.shields.io/github/stars/bartonhammond/snowflake.svg?style=social&label=Stars)](https://github.com/bartonhammond/snowflake)

#### React Native Awesome Components
* [react-native-fbsdk - A wrapper around the iOS Facebook SDK](https://github.com/facebook/react-native-fbsdk) [![GitHub stars](https://img.shields.io/github/stars/facebook/react-native-fbsdk.svg?style=social&label=Stars)](https://github.com/facebook/react-native-fbsdk)
* [react-native-side-menu - Simple customizable component to create side menu](https://github.com/Kureev/react-native-side-menu) [![GitHub stars](https://img.shields.io/github/stars/Kureev/react-native-side-menu.svg?style=social&label=Stars)](https://github.com/Kureev/react-native-side-menu)
* [react-native-mapbox-gl - A Mapbox GL react native module](https://github.com/mapbox/react-native-mapbox-gl) [![GitHub stars](https://img.shields.io/github/stars/mapbox/react-native-mapbox-gl.svg?style=social&label=Stars)](https://github.com/mapbox/react-native-mapbox-gl)
* [react-native-icons - Quick and easy icons in React Native](https://github.com/corymsmith/react-native-icons) [![GitHub stars](https://img.shields.io/github/stars/corymsmith/react-native-icons.svg?style=social&label=Stars)](https://github.com/corymsmith/react-native-icons)
* [react-native-vector-icons - 3000 Customizable Icons for React Native with support for NavBar/TabBar](https://github.com/oblador/react-native-vector-icons) [![GitHub stars](https://img.shields.io/github/stars/oblador/react-native-vector-icons.svg?style=social&label=Stars)](https://github.com/oblador/react-native-vector-icons)
* [react-native-google-signin - Google Signin for React Native](https://github.com/apptailor/react-native-google-signin) [![GitHub stars](https://img.shields.io/github/stars/apptailor/react-native-google-signin.svg?style=social&label=Stars)](https://github.com/apptailor/react-native-google-signin)
...
* [Flux GitHub](https://github.com/facebook/flux) [![GitHub stars](https://img.shields.io/github/stars/facebook/flux.svg?style=social&label=Stars)](https://github.com/facebook/flux)

#### Flux Implementations
* [Flux Comparision](https://github.com/voronianski/flux-comparison) [![GitHub stars](https://img.shields.io/github/stars/voronianski/flux-comparison.svg?style=social&label=Stars)](https://github.com/voronianski/flux-comparison)
* [RefluxJS](https://github.com/spoike/refluxjs) [![GitHub stars](https://img.shields.io/github/stars/spoike/refluxjs.svg?style=social&label=Stars)](https://github.com/spoike/refluxjs)
* [Fluxxor](https://github.com/BinaryMuse/fluxxor) [![GitHub stars](https://img.shields.io/github/stars/BinaryMuse/fluxxor.svg?style=social&label=Stars)](https://github.com/BinaryMuse/fluxxor)
* [Marty](https://github.com/martyjs/marty) [![GitHub stars](https://img.shields.io/github/stars/martyjs/marty.svg?style=social&label=Stars)](https://github.com/martyjs/marty)
* [McFly](https://github.com/kenwheeler/mcfly) [![GitHub stars](https://img.shields.io/github/stars/kenwheeler/mcfly.svg?style=social&label=Stars)](https://github.com/kenwheeler/mcfly)
* [Alt](https://github.com/goatslacker/alt) [![GitHub stars](https://img.shields.io/github/stars/goatslacker/alt.svg?style=social&label=Stars)](https://github.com/goatslacker/alt)
* [Fluxible](https://github.com/yahoo/fluxible) [![GitHub stars](https://img.shields.io/github/stars/yahoo/fluxible.svg?style=social&label=Stars)](https://github.com/yahoo/fluxible)
* [NuclearJS](https://github.com/optimizely/nuclear-js) [![GitHub stars](https://img.shields.io/github/stars/optimizely/nuclear-js.svg?style=social&label=Stars)](https://github.com/optimizely/nuclear-js)
* [Flummox](https://github.com/acdlite/flummox) [![GitHub stars](https://img.shields.io/github/stars/acdlite/flummox.svg?style=social&label=Stars)](https://github.com/acdlite/flummox)
...
* [Isomorphic Flux examples using Dispatchr and Fetchr from Yahoo](https://github.com/yahoo/flux-examples) [![GitHub stars](https://img.shields.io/github/stars/yahoo/flux-examples.svg?style=social&label=Stars)](https://github.com/yahoo/flux-examples)
...
* [FOR FLUX SAKE! - a beginners tutorial](https://github.com/MIJOTHY/FOR_FLUX_SAKE) [![GitHub stars](https://img.shields.io/github/stars/MIJOTHY/FOR_FLUX_SAKE.svg?style=social&label=Stars)](https://github.com/MIJOTHY/FOR_FLUX_SAKE)
...
* [Redux GitHub](https://github.com/reactjs/redux) [![GitHub stars](https://img.shields.io/github/stars/reactjs/redux.svg?style=social&label=Stars)](https://github.com/reactjs/redux)
* [Redux Official Site](http://redux.js.org/)
* [Awesome Redux List](https://github.com/xgrommx/awesome-redux) [![GitHub stars](https://img.shields.io/github/stars/xgrommx/awesome-redux.svg?style=social&label=Stars)](https://github.com/xgrommx/awesome-redux)

#### Redux Tools
* [react-redux - Official React bindings for Redux](https://github.com/reactjs/react-redux) [![GitHub stars](https://img.shields.io/github/stars/reactjs/react-redux.svg?style=social&label=Stars)](https://github.com/reactjs/react-redux)
* [redux-devtools - DevTools for Redux with hot reloading, action replay, and customizable UI](https://github.com/gaearon/redux-devtools) [![GitHub stars](https://img.shields.io/github/stars/gaearon/redux-devtools.svg?style=social&label=Stars)](https://github.com/gaearon/redux-devtools)
  * [react-router-redux - Bindings to keep react-router and redux in sync](https://github.com/reactjs/react-router-redux) [![GitHub stars](https://img.shields.io/github/stars/reactjs/react-router-redux.svg?style=social&label=Stars)](https://github.com/reactjs/react-router-redux)
* [redux-form - A Higher Order Component using react-redux to keep form state](https://github.com/erikras/redux-form) [![GitHub stars](https://img.shields.io/github/stars/erikras/redux-form.svg?style=social&label=Stars)](https://github.com/erikras/redux-form)
* [redux-thunk - Thunk middleware for redux](https://github.com/gaearon/redux-thunk) [![GitHub stars](https://img.shields.io/github/stars/gaearon/redux-thunk.svg?style=social&label=Stars)](https://github.com/gaearon/redux-thunk)
* [redux-logger - Logger middleware for redux](https://github.com/theaqua/redux-logger) [![GitHub stars](https://img.shields.io/github/stars/theaqua/redux-logger.svg?style=social&label=Stars)](https://github.com/theaqua/redux-logger)
* [reselect - Selector library for Redux](https://github.com/reactjs/reselect) [![GitHub stars](https://img.shields.io/github/stars/reactjs/reselect.svg?style=social&label=Stars)](https://github.com/reactjs/reselect)
* [normalizr - Normalizes nested JSON according to a schema](https://github.com/paularmstrong/normalizr) [![GitHub stars](https://img.shields.io/github/stars/paularmstrong/normalizr.svg?style=social&label=Stars)](https://github.com/paularmstrong/normalizr)
* [redux-saga - An alternative side effect model for Redux apps](https://github.com/yelouafi/redux-saga) [![GitHub stars](https://img.shields.io/github/stars/yelouafi/redux-saga.svg?style=social&label=Stars)](https://github.com/yelouafi/redux-saga)
* [redux-observable - RxJS middleware for Redux](https://github.com/redux-observable/redux-observable) [![GitHub stars](https://img.shields.io/github/stars/redux-observable/redux-observable.svg?style=social&label=Stars)](https://github.com/redux-observable/redux-observable)
* [redux-analytics - Analytics middleware for Redux](https://github.com/markdalgleish/redux-analytics) [![GitHub stars](https://img.shields.io/github/stars/markdalgleish/redux-analytics.svg?style=social&label=Stars)](https://github.com/markdalgleish/redux-analytics)
* [redux-undo - Higher order reducer to add undo/redo functionality to redux state containers](https://github.com/omnidan/redux-undo) [![GitHub stars](https://img.shields.io/github/stars/omnidan/redux-undo.svg?style=social&label=Stars)](https://github.com/omnidan/redux-undo)
* [redux-search - Redux bindings for client-side search](https://github.com/treasure-data/redux-search) [![GitHub stars](https://img.shields.io/github/stars/treasure-data/redux-search.svg?style=social&label=Stars)](https://github.com/treasure-data/redux-search)
* [redux-mock-store - A mock store for your testing your redux async action creators and middleware](https://github.com/arnaudbenard/redux-mock-store) [![GitHub stars](https://img.shields.io/github/stars/arnaudbenard/redux-mock-store.svg?style=social&label=Stars)](https://github.com/arnaudbenard/redux-mock-store)
* [redux-immutable - Create an equivalent function of Redux combineReducers that works with Immutable.js state](https://github.com/gajus/redux-immutable) [![GitHub stars](https://img.shields.io/github/stars/gajus/redux-immutable.svg?style=social&label=Stars)](https://github.com/gajus/redux-immutable)
* [redux-react-i18n - An i18n solution for redux/react](https://github.com/derzunov/redux-react-i18n) [![GitHub stars](https://img.shields.io/github/stars/derzunov/redux-react-i18n.svg?style=social&label=Stars)](https://github.com/derzunov/redux-react-i18n)
...
* [Redux Tutorial](https://github.com/happypoulp/redux-tutorial) [![GitHub stars](https://img.shields.io/github/stars/happypoulp/redux-tutorial.svg?style=social&label=Stars)](https://github.com/happypoulp/redux-tutorial)
...
* [React Redux based blood donor demo application](https://github.com/smanne/reduxnor) [![GitHub stars](https://img.shields.io/github/stars/smanne/reduxnor.svg?style=social&label=Stars)](https://github.com/smanne/reduxnor)
...
* [MobX GitHub](https://github.com/mobxjs/mobx) [![GitHub stars](https://img.shields.io/github/stars/mobxjs/mobx.svg?style=social&label=Stars)](https://github.com/mobxjs/mobx)
* [MobX Official Site](https://mobxjs.github.io/mobx/)

#### MobX Tools
* [mobx-react - React component wrapper for combining React with MobX](https://github.com/mobxjs/mobx-react) [![GitHub stars](https://img.shields.io/github/stars/mobxjs/mobx-react.svg?style=social&label=Stars)](https://github.com/mobxjs/mobx-react)
...
* [enzyme - JavaScript Testing utilities for React](https://github.com/airbnb/enzyme) [![GitHub stars](https://img.shields.io/github/stars/airbnb/enzyme.svg?style=social&label=Stars)](https://github.com/airbnb/enzyme)
...
* [GraphQL Specification Repository](https://github.com/facebook/graphql) [![GitHub stars](https://img.shields.io/github/stars/facebook/graphql.svg?style=social&label=Stars)](https://github.com/facebook/graphql)

#### GraphQL Tools
* [GraphQL CMS](https://github.com/sarkistlt/graphql-auto-generating-cms) [![GitHub stars](https://img.shields.io/github/stars/sarkistlt/graphql-auto-generating-cms.svg?style=social&label=Stars)](https://github.com/sarkistlt/graphql-auto-generating-cms)
* [Mongoose schema To GraphQL](https://github.com/sarkistlt/mongoose-schema-to-graphql) [![GitHub stars](https://img.shields.io/github/stars/sarkistlt/mongoose-schema-to-graphql.svg?style=social&label=Stars)](https://github.com/sarkistlt/mongoose-schema-to-graphql)
...
* [graphql-js - A reference implementation of GraphQL for **JavaScript**](https://github.com/graphql/graphql-js) [![GitHub stars](https://img.shields.io/github/stars/graphql/graphql-js.svg?style=social&label=Stars)](https://github.com/graphql/graphql-js)
* [react-transmit - Relay-inspired library based on **JavaScript Promises**](https://github.com/RickWong/react-transmit) [![GitHub stars](https://img.shields.io/github/stars/RickWong/react-transmit.svg?style=social&label=Stars)](https://github.com/RickWong/react-transmit)
* [graphql-ruby - **Ruby** implementation of Facebook's GraphQL](https://github.com/rmosolgo/graphql-ruby) [![GitHub stars](https://img.shields.io/github/stars/rmosolgo/graphql-ruby.svg?style=social&label=Stars)](https://github.com/rmosolgo/graphql-ruby)
* [graphql-java - GraphQL **Java** implementation](https://github.com/andimarek/graphql-java) [![GitHub stars](https://img.shields.io/github/stars/andimarek/graphql-java.svg?style=social&label=Stars)](https://github.com/andimarek/graphql-java)
* [sangria - **Scala** GraphQL client and server library](https://github.com/OlegIlyenko/sangria) [![GitHub stars](https://img.shields.io/github/stars/OlegIlyenko/sangria.svg?style=social&label=Stars)](https://github.com/OlegIlyenko/sangria)
* [graphql-php - A **PHP** port of GraphQL reference implementation](https://github.com/webonyx/graphql-php) [![GitHub stars](https://img.shields.io/github/stars/webonyx/graphql-php.svg?style=social&label=Stars)](https://github.com/webonyx/graphql-php)
* [graphene - GraphQL in **Python** made simple](http://graphene-python.org/)
* [graphqllib - GraphQL implementation for **Python**](https://github.com/dittos/graphqllib) [![GitHub stars](https://img.shields.io/github/stars/dittos/graphqllib.svg?style=social&label=Stars)](https://github.com/dittos/graphqllib)
* [graphql-dotnet - GraphQL for **.NET**](https://github.com/graphql-dotnet/graphql-dotnet) [![GitHub stars](https://img.shields.io/github/stars/graphql-dotnet/graphql-dotnet.svg?style=social&label=Stars)](https://github.com/graphql-dotnet/graphql-dotnet)
* [graphql-go - GraphQL for Go/Golang](https://github.com/graphql-go/graphql) [![GitHub stars](https://img.shields.io/github/stars/graphql-go/graphql.svg?style=social&label=Stars)](https://github.com/graphql-go/graphql)

#### Server Integration
* [express-graphql - Create a GraphQL HTTP server with **Express**](https://github.com/graphql/express-graphql) [![GitHub stars](https://img.shields.io/github/stars/graphql/express-graphql.svg?style=social&label=Stars)](https://github.com/graphql/express-graphql)

#### Database Integration
* [graphql-bookshelf - Some help defining GraphQL schema around BookshelfJS models](https://github.com/brysgo/graphql-bookshelf) [![GitHub stars](https://img.shields.io/github/stars/brysgo/graphql-bookshelf.svg?style=social&label=Stars)](https://github.com/brysgo/graphql-bookshelf)
* [GraphpostgresQL - GraphQL for **PostgreSQL**](https://github.com/solidsnack/GraphpostgresQL) [![GitHub stars](https://img.shields.io/github/stars/solidsnack/GraphpostgresQL.svg?style=social&label=Stars)](https://github.com/solidsnack/GraphpostgresQL)
* [graffiti - Node.js GraphQL ORM](https://github.com/RisingStack/graffiti) [![GitHub stars](https://img.shields.io/github/stars/RisingStack/graffiti.svg?style=social&label=Stars)](https://github.com/RisingStack/graffiti)
* [sql-to-graphql - Generate a GraphQL API based on your SQL database structure](https://github.com/vaffel/sql-to-graphql) [![GitHub stars](https://img.shields.io/github/stars/vaffel/sql-to-graphql.svg?style=social&label=Stars)](https://github.com/vaffel/sql-to-graphql)
* [graphql-sequelize - GraphQL & Relay for MySQL & Postgres via Sequelize](https://github.com/mickhansen/graphql-sequelize) [![GitHub stars](https://img.shields.io/github/stars/mickhansen/graphql-sequelize.svg?style=social&label=Stars)](https://github.com/mickhansen/graphql-sequelize)
...
* [Relay GitHub](https://github.com/facebook/relay) [![GitHub stars](https://img.shields.io/github/stars/facebook/relay.svg?style=social&label=Stars)](https://github.com/facebook/relay)
...
#### Relay Tools
* [graphql-relay-js - A library to help construct a graphql-js server supporting react-relay](https://github.com/graphql/graphql-relay-js) [![GitHub stars](https://img.shields.io/github/stars/graphql/graphql-relay-js.svg?style=social&label=Stars)](https://github.com/graphql/graphql-relay-js)
* [react-router-relay - Relay integration for React Router](https://github.com/relay-tools/react-router-relay) [![GitHub stars](https://img.shields.io/github/stars/relay-tools/react-router-relay.svg?style=social&label=Stars)](https://github.com/relay-tools/react-router-relay)
* [relay-local-schema - Use Relay without a GraphQL server](https://github.com/relay-tools/relay-local-schema) [![GitHub stars](https://img.shields.io/github/stars/relay-tools/relay-local-schema.svg?style=social&label=Stars)](https://github.com/relay-tools/relay-local-schema)
* [relay-codemod -  Codemod scripts based for on jsodeshift to update Relay APIs](https://github.com/facebook/jscodeshift) [![GitHub stars](https://img.shields.io/github/stars/facebook/jscodeshift.svg?style=social&label=Stars)](https://github.com/facebook/jscodeshift)
...
* [Flow GitHub](https://github.com/facebook/flow) [![GitHub stars](https://img.shields.io/github/stars/facebook/flow.svg?style=social&label=Stars)](https://github.com/facebook/flow)
...
* [react-hn - A React & react-router-powered implementation of Hacker News](https://github.com/insin/react-hn) [![GitHub stars](https://img.shields.io/github/stars/insin/react-hn.svg?style=social&label=Stars)](https://github.com/insin/react-hn)
* [react-pokemon - A React component for displaying Pokémon](https://github.com/passy/react-pokemon) [![GitHub stars](https://img.shields.io/github/stars/passy/react-pokemon.svg?style=social&label=Stars)](https://github.com/passy/react-pokemon)
* [React + Backbone TodoMVC](http://todomvc.com/examples/react-backbone/)
* [React + NestedTypes TodoMVC](https://github.com/gaperton/todomvc-nestedreact) [![GitHub stars](https://img.shields.io/github/stars/gaperton/todomvc-nestedreact.svg?style=social&label=Stars)](https://github.com/gaperton/todomvc-nestedreact)
* [react-rxjs-todomvc - TodoMVC implementation with React and RxJS](https://github.com/fdecampredon/react-rxjs-todomvc) [![GitHub stars](https://img.shields.io/github/stars/fdecampredon/react-rxjs-todomvc.svg?style=social&label=Stars)](https://github.com/fdecampredon/react-rxjs-todomvc)
* [react-mvc - A sample chat application written with React and pure MVC](https://github.com/ustun/react-mvc) [![GitHub stars](https://img.shields.io/github/stars/ustun/react-mvc.svg?style=social&label=Stars)](https://github.com/ustun/react-mvc)
* [react-observe-todomvc - TodoMVC implementation built on top of React and Object.observe](https://github.com/fdecampredon/react-observe-todomvc) [![GitHub stars](https://img.shields.io/github/stars/fdecampredon/react-observe-todomvc.svg?style=social&label=Stars)](https://github.com/fdecampredon/react-observe-todomvc)
* [react-lights-out - Simple demo of the React framework's power and flexibility](https://github.com/chenglou/react-lights-out) [![GitHub stars](https://img.shields.io/github/stars/chenglou/react-lights-out.svg?style=social&label=Stars)](https://github.com/chenglou/react-lights-out)
* [todomvc-swarm - React TodoMVC implementation using Swarm for real-time collaboration](https://github.com/gritzko/todomvc-swarm) [![GitHub stars](https://img.shields.io/github/stars/gritzko/todomvc-swarm.svg?style=social&label=Stars)](https://github.com/gritzko/todomvc-swarm)
* [reactodo - Multiple localStorage TODO lists, built with React](https://github.com/insin/reactodo) [![GitHub stars](https://img.shields.io/github/stars/insin/reactodo.svg?style=social&label=Stars)](https://github.com/insin/reactodo)
* [lifequote - React port of a life insurance quick quoting application](https://github.com/insin/lifequote) [![GitHub stars](https://img.shields.io/github/stars/insin/lifequote.svg?style=social&label=Stars)](https://github.com/insin/lifequote)
* [reactor-demo - Isomorphic Javascript app with React](https://github.com/natew/reactor-demo) [![GitHub stars](https://img.shields.io/github/stars/natew/reactor-demo.svg?style=social&label=Stars)](https://github.com/natew/reactor-demo)
* [imgsible - React-based Imgur-like isomorphic demo app](https://github.com/BinaryMuse/imgsible) [![GitHub stars](https://img.shields.io/github/stars/BinaryMuse/imgsible.svg?style=social&label=Stars)](https://github.com/BinaryMuse/imgsible)
* [wow-realm-status-react - WoW Realm Status: React Edition](https://github.com/BinaryMuse/wow-realm-status-react) [![GitHub stars](https://img.shields.io/github/stars/BinaryMuse/wow-realm-status-react.svg?style=social&label=Stars)](https://github.com/BinaryMuse/wow-realm-status-react)
* [react-json-editor - A generic JSON editor](https://github.com/dustingetz/react-json-editor) [![GitHub stars](https://img.shields.io/github/stars/dustingetz/react-json-editor.svg?style=social&label=Stars)](https://github.com/dustingetz/react-json-editor)
* [react-todos - Backbone's example TODO app with React JS for views](https://github.com/ssorallen/react-todos) [![GitHub stars](https://img.shields.io/github/stars/ssorallen/react-todos.svg?style=social&label=Stars)](https://github.com/ssorallen/react-todos)
* [github-issues-viewer - A gitub issues viewer build in react + backbone](https://github.com/jaredly/github-issues-viewer) [![GitHub stars](https://img.shields.io/github/stars/jaredly/github-issues-viewer.svg?style=social&label=Stars)](https://github.com/jaredly/github-issues-viewer)
* [wolfenstein3D-react - Wolfenstein with the rendering layer written in React](https://github.com/petehunt/wolfenstein3D-react) [![GitHub stars](https://img.shields.io/github/stars/petehunt/wolfenstein3D-react.svg?style=social&label=Stars)](https://github.com/petehunt/wolfenstein3D-react)
* [Flux ImmutableJS TodoList](https://github.com/MandarinConLaBarba/flux-immutable-todomvc) [![GitHub stars](https://img.shields.io/github/stars/MandarinConLaBarba/flux-immutable-todomvc.svg?style=social&label=Stars)](https://github.com/MandarinConLaBarba/flux-immutable-todomvc)
* [Hapi+React+Flux user management system](https://github.com/jedireza/aqua) [![GitHub stars](https://img.shields.io/github/stars/jedireza/aqua.svg?style=social&label=Stars)](https://github.com/jedireza/aqua)
* [Redux TodoMVC](https://github.com/gaearon/redux/tree/master/examples/todomvc)
* [react-babel-webpack - CRUD demo app featuring React, React Router, Flux, Webpack, Bootstrap](https://github.com/arcseldon/react-babel-webpack-starter-app) [![GitHub stars](https://img.shields.io/github/stars/arcseldon/react-babel-webpack-starter-app.svg?style=social&label=Stars)](https://github.com/arcseldon/react-babel-webpack-starter-app)


---
### Example Apps
* [isomorphic500 - Isomorphic JS app built with React and Fluxible](https://github.com/gpbl/isomorphic500) [![GitHub stars](https://img.shields.io/github/stars/gpbl/isomorphic500.svg?style=social&label=Stars)](https://github.com/gpbl/isomorphic500)
* [fil -  A playground for in-browser interpreters (Redux)](https://github.com/fatiherikli/fil) [![GitHub stars](https://img.shields.io/github/stars/fatiherikli/fil.svg?style=social&label=Stars)](https://github.com/fatiherikli/fil)
* [sound-redux - A Soundcloud client built with React / Redux](https://github.com/andrewngu/sound-redux) [![GitHub stars](https://img.shields.io/github/stars/andrewngu/sound-redux.svg?style=social&label=Stars)](https://github.com/andrewngu/sound-redux)
* [react-pomodoro - A Pomodoro timer for developers](https://github.com/afonsopacifer/react-pomodoro) [![GitHub stars](https://img.shields.io/github/stars/afonsopacifer/react-pomodoro.svg?style=social&label=Stars)](https://github.com/afonsopacifer/react-pomodoro)
* [Do - Notes management application built with React and Redux](https://github.com/1ven/do) [![GitHub stars](https://img.shields.io/github/stars/1ven/do.svg?style=social&label=Stars)](https://github.com/1ven/do)

---
### Real Apps
* [reddit/reddit-mobile](https://github.com/reddit/reddit-mobile) [![GitHub stars](https://img.shields.io/github/stars/reddit/reddit-mobile.svg?style=social&label=Stars)](https://github.com/reddit/reddit-mobile)
* [khan/perseus](https://github.com/khan/perseus) [![GitHub stars](https://img.shields.io/github/stars/khan/perseus.svg?style=social&label=Stars)](https://github.com/khan/perseus)
* [mozilla/payments-ui](https://github.com/mozilla/payments-ui) [![GitHub stars](https://img.shields.io/github/stars/mozilla/payments-ui.svg?style=social&label=Stars)](https://github.com/mozilla/payments-ui)
* [webbylab/itsquiz-wall](https://github.com/webbylab/itsquiz-wall) [![GitHub stars](https://img.shields.io/github/stars/webbylab/itsquiz-wall.svg?style=social&label=Stars)](https://github.com/webbylab/itsquiz-wall)
* [brainfock/brainfock](https://github.com/brainfock/brainfock) [![GitHub stars](https://img.shields.io/github/stars/brainfock/brainfock.svg?style=social&label=Stars)](https://github.com/brainfock/brainfock)
